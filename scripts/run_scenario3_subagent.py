...
async def run_legacy_mode(config_path: Path, model: str, scenario_name: str = "research_assistant") -> dict:
...
async def run_subagent_mode(config_path: Path, model: str, scheduler: str = "brute_force", scenario_name: str = "research_assistant") -> dict:
...
def save_result(result_dict: dict, output_dir: str = "results/scenario3_subagent"):
    """Save execution result to JSON and CSV files using metrics.py utilities"""
    scenario_name = result_dict.get("scenario_name", "research_assistant")
