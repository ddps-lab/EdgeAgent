...
def summarize_text(
    ...
    result = measure_io(lambda: _summarize_text_impl(text, max_length, style))
    timer.finish()
    return result
...
def summarize_documents(
    ...
    result = measure_io(lambda: [_summarize_text_impl(doc, max_length_per_doc, style) for doc in documents])
    timer.finish()
    return result
